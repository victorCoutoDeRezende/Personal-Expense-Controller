...
colors = ["#007fff", "#ff2222", "#00ff7f", "#d48748", "#b648d4", "#f7f259", "#5e5e5e"]
dark_background = ["dark_background","#333333", "#ffffff", "#5da6f0"]
...
def resume(theme, y, message, list_index):
    ...
    label_summary = Label(midframe, text=message.upper(), anchor=NW, font=("Verdana 12"), fg=dark_background[3])
